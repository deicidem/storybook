...
import { default as meta } from '../PpdCombobox.stories';

export default function renderComponent(component: Component, argTypes: typeof meta.argTypes): import('../../../../../vue/dist/vue.esm.js/types/vue').ExtendedVue<Vue<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => Vue<Record<string, any>, Record<string, any>, never, never, any>>, unknown, unknown, unknown, Record<"delimiters" | "value" | "filter" | "label" | "success" | "warning" | "error" | "loading" | "noDataText" | "counter" | "disabled" | "errorCount" | "errorMessages" | "hideDetails" | "hint" | "messages" | "persistentHint" | "readonly" | "rules" | "successMessages" | "validateOnBlur" | "warningMessage" | "multiple" | "autofocus" | "autoSelectFirst" | "cacheItems" | "chips" | "clearable" | "counterValue" | "deletableChips" | "disableLookup" | "eager" | "hideNoData" | "hideSelected" | "itemColor" | "itemDisabled" | "itemText" | "itemValue" | "items" | "noFilter" | "openOnClear" | "persistentPlaceholder" | "placeholder" | "prefix" | "returnObject" | "searchInput" | "smallChips" | "suffix" | "valueComparator" | "hideComboboxed" | import('../../../../../vue/dist/vue.esm.js/types/v3-component-props').DefaultKeys<{
    delimiters: {
    ...
    filter: {
        type: import('../../../../../vue/dist/vue.esm.js').PropType<(value: any, search: string, item: any) => boolean>;
    };
    label: {
